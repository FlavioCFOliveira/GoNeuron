...
func BenchmarkDenseForward(b *testing.B) {
	layer , _ := NewDense(784, 256, activations.Tanh{})
...
func BenchmarkDenseLarge(b *testing.B) {
	layer , _ := NewDense(1024, 1024, activations.Tanh{})
...
func BenchmarkConv2DForward(b *testing.B) {
	...
	layer , _ := NewConv2D(3, 64, 3, 1, 1, activations.Tanh{})
...
func BenchmarkConv2DLarge(b *testing.B) {
	...
	layer , _ := NewConv2D(64, 128, 3, 1, 1, activations.Tanh{})
...
func BenchmarkLSTMForward(b *testing.B) {
	layer , _ := NewLSTM(256, 512) // Typical LSTM config
